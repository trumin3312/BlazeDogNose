...
class Blaze(nn.Module):
    ...
    def multibox(self, num_classes):
        ...
        landm_layers += [depth_conv2d(96, 2 * 4, kernel=3, pad=1)]
        ...
        landm_layers += [depth_conv2d(96, 6 * 4, kernel=3, pad=1)]
    ...
    def forward(self,inputs):
        ...
        ldm_regressions = torch.cat([o.view(o.size(0), -1, 4) for o in landm], 1)
